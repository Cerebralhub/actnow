...
<div class="container-fluid" style="padding-top:100px;">
    ...
    border-radius:20px; padding-top: 30px; color:#5D3954">
        ...
        <div class="image">    
            ...
            <img src="{{ asset('uploads/profiles/'.$item->profile_image) }}" alt="Image" style="width:70%; border-radius:50%">
        </div><br/>
        <div class="card-body">
          <h2 class="card-title" style="font-weight: 700;">{{$item->name}}</h2>
          <p class="card-text">
          <h6 style="padding-top: 10px;">MEMBERSHIP CARD</h6>
            <!-- <hr/> -->
            <h6>ID: ACT-{{$item->reg_no}}</h6>
          </p>
            <p style="font-size:25px; font-weight:700; padding-bottom:30px;">{{$item->state}} State</p>
        </div>
        <div class="down">www.actnow.ng</div><br/>
        </div>
        </div>
        <a href="{{url('/download', $item->id)}}">Download PDF</a>
